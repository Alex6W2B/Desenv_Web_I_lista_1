    ...
    <body>
        <header class="header">
            ...
            <div class="container w-75 d-flex justify-content-between py-2 pe-0">
                ...
                <div class="d-inline-flex ">
                    ...
                    <a href="pgcarrinho.html" class="d-flex mx-2 b"><img src="svg/cart3 (1).svg" width="30px" alt=""></a>
                    <a href="pglogin.html" class="d-flex mx-2 b"><img src="svg/person-circle (1).svg" width="30px" alt=""></a>
                </div>
        ...
        <main>
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="home.html" class=" text-muted text-decoration-none">Home</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="pgprincipal.html" class="text-muted text-decoration-none">Página Inicial</a>
                </li>
                <li class="breadcrumb-item active" arial-current="pace">
                    <a href="pgproduto.html" class="text-muted text-decoration-none">Camiseta</a>
                </li>
                <li class="breadcrumb-item active" arial-current="pace">
                    Finalizar Compra
                </li>
          ...
          <div class="container w-75">
            <h2 class="border-bottom mb-3 pb-1 pt-2">Finalizar compra</h2>

            <form action="">
                <label for="nomeId" class="from-label">Nome:</label> 
                <input type="text" class="form-control" name="nome" id="nomeId" placeholder="Juan Pablo">
                
                <label for="dataNascimentoId" class="from-label">Data nascimento:</label>
                <input type="date" class="form-control" name="dataNascimento" id="dataNascimentoId">

                <label for="emailId" class="from-label">Email:</label>
                <input type="Email" class="form-control" name="email" id="emailId" placeholder="name@gmail.com">

                <label for="senha1Id" class="from-label">CPF:</label>
                <input type="Password" class="form-control" name="senha1" id="senha1Id" placeholder="896.512.748-03">

                <label for="senha2Id" class="from-label">CEP:</label>
                <input type="Password" class="form-control" name="senha2" id="senha2Id" placeholder="89595-000">

                <br>
                <input type="checkbox" class="form-check-input" name="noticias" id="noticiasId">
                <label for="noticiasId" class="form-check-label">Receber novidades da loja</label>

                


                <section class="d-flex justify-content-start pt-1 dados">
                    ...
                    <section class="col-5 mt-2 align-self-center">
                ...
                <div class="pt-4">
                    <div class="col-6">
                        ...
                        <div>
                            <input type="radio" class="form-check-input" name="contrato" id="contratoSimId"> 
                            <label for="contratoSimId"><img src="svg/bandeiras de cartões/elo 1.png" alt="" width="60px" class=""></label>

                            <input type="radio" class="form-check-input" name="contrato" id="contratoSimId"> 
                            <label for="contratoSimId"><img src="svg/bandeiras de cartões/amex-american-express-logo.svg" alt="" width="50px" class=""></label>

                            <input type="radio" class="form-check-input" name="contrato" id="contratoSimId"> 
                            <label for="contratoSimId"><img src="svg/bandeiras de cartões/mc_vrt_pos.svg" alt="" width="60px" class=""></label>

                            <input type="radio" class="form-check-input" name="contrato" id="contratoSimId"> 
                            <label for="contratoSimId"><img src="svg/bandeiras de cartões/visa.png" alt="" width="60px" class=""></label>

                            <input type="radio" class="form-check-input" name="contrato" id="contratoSimId"> 
                            <label for="contratoSimId"><img src="svg/bandeiras de cartões/banco-do-brasil-3.svg" alt="" width="40px" class=""></label>
                        </div>
                    </div>
                    <div class="col-3 pt-3">
                        <label for="senha2Id" class="from-label">Informe o número do cartão:</label>
                        <input type="Password" class="form-control" name="senha2" id="senha2Id" placeholder="xxxx xxxx xxxx xxxx">
                    </div>
                </div>
                
                <br><br>
                <label>Concorda com os termos do contrato?</label>                    
                <input type="radio" class="form-check-input" name="contrato" id="contratoSimId"> 
                <label for="contratoSimId">Sim</label>
                <input type="radio" class="form-check-input"  name="contrato" id="contratoNaoId"> 
                <label for="contratoNaoId">Não</label>
